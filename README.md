...
- Timestamp: `2022-06-19 12:58`
- Build ID: `144ae725-d9e8-4848-9f1f-f653412394ef`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/144ae725-d9e8-4848-9f1f-f653412394ef.git
$ cd 144ae725-d9e8-4848-9f1f-f653412394ef
```
